...
import { useCategoriasCartas } from '@/lib/hooks/useCategorias';
import { CategoriaCartas } from '@/types';

export default function CategoriaCartaPage() {
  const {
    categorias,
    loading,
    createCategoria,
  ...
  const handleEdit = (categoria: CategoriaCartas) => {
    setEditing(categoria);
    setFormData({ nome: categoria.nome, descricao: categoria.descricao || '' });
    setShowModal(true);
  };

  const handleDelete = async (categoria: CategoriaCartas) => {
