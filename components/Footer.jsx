...
const Footer = () => {
  ...
  const linkSections = [
    ...
    },
    {
      title: "Fale conosco",
      links: [
        { text: "(21) 3297-7913", path: "/", icon: PhoneIcon },
        { text: "infopoketrade@gmail.com.br", path: "/", icon: MailIcon },
      ],
    },
  ];
    ...
    <footer id="contato" className="px-6 bg-black py-30">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            <Link href="/" className="text-4xl font-semibold text-slate-700">
              <span className="text-[#00004F]-600">Poké</span>Trade
            </Link>
            <p className="max-w-[410px] mt-6 text-sm">
              Atendemos a todas as necessidades dos clientes. Nossa equipe atua
              no setor há mais de 2 anos e o nosso objetivo é fornecer produtos,
              serviços e atendimento da mais alta qualidade pelos menores
              preços.
            </p>
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright 2025 © PokéTrade All Right Reserved.
        </p>
      </div>
    </footer>
  );
